...
//
//     final quoteQuotationModule = quoteQuotationModuleFromMap(jsonString);

import 'dart:convert';

QuoteQuotationModule quoteQuotationModuleFromMap(String str) =>
    QuoteQuotationModule.fromMap(json.decode(str));

String quoteQuotationModuleToMap(QuoteQuotationModule data) =>
    json.encode(data.toMap());

class QuoteQuotationModule {
  Data? data;
  String? message;
  ...
  factory QuoteQuotationModule.fromMap(Map<String, dynamic> json) =>
      QuoteQuotationModule(
...
class Data {
  ...
  factory Data.fromMap(Map<String, dynamic> json) => Data(
        ...
        previousQuotes: json["previousQuotes"] == null
            ? []
            : List<Data>.from(
                json["previousQuotes"]!.map((x) => Data.fromMap(x))),
...
class QuoteLineItem {
  ...
  Map<String, dynamic> toMap() => {
        ...
        'isToleranceApplicableProduct': isToleranceApplicableProduct,
