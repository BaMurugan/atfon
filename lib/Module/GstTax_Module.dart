...
//
//     final gstTaxModule = gstTaxModuleFromMap(jsonString);

import 'dart:convert';

GstTaxModule gstTaxModuleFromMap(String str) =>
    GstTaxModule.fromMap(json.decode(str));

String gstTaxModuleToMap(GstTaxModule data) => json.encode(data.toMap());
...
class GstTaxModule {
  ...
  factory GstTaxModule.fromMap(Map<String, dynamic> json) => GstTaxModule(
