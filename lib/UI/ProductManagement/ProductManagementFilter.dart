...
class ManagementFilterButton extends StatefulWidget {
  const ManagementFilterButton({super.key});

  @override
  State<ManagementFilterButton> createState() => _ManagementFilterButtonState();
}

class _ManagementFilterButtonState extends State<ManagementFilterButton> {
  final controller = Get.find<ProductManagementService>();
  List filteredList = [];
  int filterIndex = 0;
  @override
